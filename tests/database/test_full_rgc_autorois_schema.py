...
def test_populate_user(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import UserInfo
    userinfo = {
...
def test_populate_raw_data_params(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import RawDataParams
...
def test_populate_experiment(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Experiment
...
def test_populate_field(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Field
...
def test_populate_stimulus(database_fixture):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import Stimulus
...
def test_populate_presentation(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Presentation
...
def test_populate_roi_mask(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import RoiMask
...
def test_populate_roi(database_fixture, processes=20):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Roi
...
def test_populate_traces(database_fixture, processes=20):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Traces
...
def test_populate_preprocessparams(database_fixture):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import PreprocessParams
...
def test_populate_preprocesstraces(database_fixture, processes=20):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import PreprocessTraces
...
def test_populate_snippets(database_fixture, processes=20):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Snippets
...
def test_populate_averages(database_fixture, processes=20):
    ...
    if not is_connected(connection):
        pytest.skip("Not connected to database")
    from djimaging.schemas.full_rgc_autorois_schema import Averages
...
def test_populate_chirp_qi(database_fixture, processes=20):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import ChirpQI
...
def test_populate_chirp_features(database_fixture, processes=20):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import ChirpFeatures
...
def test_populate_os_ds_indexes(database_fixture, processes=20):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import OsDsIndexes
...
def test_populate_baden16_traces(database_fixture, processes=20):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import Baden16Traces
...
def test_populate_classifier_training_data(database_fixture):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import ClassifierTrainingData
...
def test_populate_classifier_method(database_fixture):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import ClassifierMethod
...
def test_populate_classifier(database_fixture):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import Classifier
    Classifier().populate()
...
def test_populate_celltype_assignment(database_fixture):
    ...
    from djimaging.schemas.full_rgc_autorois_schema import CelltypeAssignment
