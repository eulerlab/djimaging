...
def prepare_noise_data(stim, triggertimes, trace, tracetime,
                       ntrigger_per_frame=1, fupsample_trace=None, fupsample_stim=None, fit_kind='trace',
...
def preprocess_stimulus(stim, triggertimes, ntrigger_per_frame, fupsample_stim):
...
def preprocess_trace(tracetime, trace, fupsample_trace=None, fit_kind='trace', lowpass_cutoff=0, pre_blur_sigma_s=0,
                     dt_rtol=0.1):
...
def transform_trace(tracetime, trace, kind='trace', fupsample=None, dt=None):
...
def finalize_trace(trace, dt, post_blur_sigma_s):
